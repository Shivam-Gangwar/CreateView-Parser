...
column: id comma column
		|agrfunc comma column
		|agrfunc
		|id

;
	/*
	if column label is called it could start with either identifier, id , or any agrfunc (cnt, sum, avg) 
	followed by comma column, or there will be no column needed in query
	*/
